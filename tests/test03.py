...
borderpadding1 = urwid.Padding(lineboxmap1, width=9, left=1, right=1)
borderpadding2 = urwid.Padding(lineboxmap2, width=9, left=1, right=1)
borderpadding3 = urwid.Padding(lineboxmap3, width=9, left=1, right=1)
borderpadding4 = urwid.Padding(lineboxmap4, width=9, left=1, right=1)

borderfiller1 = urwid.Filler(borderpadding1, height=7)
borderfiller2 = urwid.Filler(borderpadding2, height=7)
borderfiller3 = urwid.Filler(borderpadding3, height=7)
borderfiller4 = urwid.Filler(borderpadding4, height=7)
