...
padding1 = urwid.Padding(txtmap1, align='center', width=20)
padding2 = urwid.Padding(txtmap2, align='center', width=20)
padding3 = urwid.Padding(txtmap3, align='center', width=20)
padding4 = urwid.Padding(txtmap4, align='center', width=20)

filler1 = urwid.Filler(padding1, valign='top', height=60)
filler2 = urwid.Filler(padding2, valign='top', height=60)
filler3 = urwid.Filler(padding3, valign='top', height=60)
filler4 = urwid.Filler(padding4, valign='top', height=60)
...
borderpadding1 = urwid.Padding(lineboxmap1, align='center', width=1, left=5, right=5)
borderpadding2 = urwid.Padding(lineboxmap2, align='center', width=1, left=5, right=5)
borderpadding3 = urwid.Padding(lineboxmap3, align='center', width=1, left=5, right=5)
borderpadding4 = urwid.Padding(lineboxmap4, align='center', width=1, left=5, right=5)

borderfiller1 = urwid.Filler(borderpadding1, valign='top', height=1, top=5, bottom=5)
borderfiller2 = urwid.Filler(borderpadding2, valign='top', height=1, top=5, bottom=5)
borderfiller3 = urwid.Filler(borderpadding3, valign='top', height=1, top=5, bottom=5)
borderfiller4 = urwid.Filler(borderpadding4, valign='top', height=1, top=5, bottom=5)
